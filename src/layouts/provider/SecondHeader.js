            ...
            <ul className="wsmenu-list">
              ...
              <li aria-haspopup="true">
                <Link
                  ...
                  className={
                    [routes.networkDirectory, routes.userDetail].includes(
                      location.pathname
                    )
                      ? "wshomelink active"
                      : "wshomelink"
              ...
              <li aria-haspopup="true">
                <Link
                  to={routes.transactionList}
                  className={
                    [routes.transactionList].includes(location.pathname)
                      ? "wshomelink active"
                      : "wshomelink"
                  }
                >
                  ...
                  <span className="wsmenutext"> Transaction History</span>
                </Link>
              </li>
                ...
                <Link
                  ...
                  className={
                    [
                      ...
                      routes.subscriptionPaymentSuccess,
                      routes.subscriptionPaymentError,
                    ].includes(location.pathname)
                      ? "wshomelink active"
                      : "wshomelink"
                  }
